      ...
      <label style="color: blue; ">Jika data diinput tidak ada, isikan dengan simbol minus (-)</label>
        <form action="<?php echo base_url('anggota/edit/').$data->id_anggota ?>" method="post" role=form enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?= $data->no_hp ?>" placeholder="Masukkan Nomor Hp..." required>
          </div>
          <div class="form-group">
            <label for="tgl_lahir">Tgl_Lahir:</label>
            <input type="date" class="form-control" id="tgl_lahir" value="<?= $data->tgl_lahir ?>" name="tgl_lahir" required>
          </div>
          <div class="form-group">
            <label for="alamat">Alamat:</label>
            <textarea name="alamat" id="alamat" rows="4" class="form-control" style="resize: none;" placeholder="Masukkan Alamat..." required><?= $data->alamat ?></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="email" name="email" value="<?= $data->email ?>" placeholder="Masukkan Email..." required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <img src="<?= base_url('assets/image/').$data->foto ?>" alt="foto" width="60" height="70">
